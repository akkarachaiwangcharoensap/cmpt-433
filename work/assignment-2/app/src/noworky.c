...
{
	// The issue was here: unsigned value only contain positive values.
	// When i = 0, then i--, the value overflows, resulting in: i = 4494962495 which does not exist -> segfault.
	int i;
	for (i = size-1; i >= 0; i--) {
