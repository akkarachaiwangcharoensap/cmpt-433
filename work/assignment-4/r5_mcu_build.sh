...
echo "Copying to NFS..."
mkdir -p ~/cmpt-433/public/r5/
cp build/zephyr/zephyr.elf ~/cmpt-433/public/r5/zephyr_mcu_neopixel.elf
cp ./load_r5_mcu.sh ~/cmpt-433/public/r5/
chmod +x ~/cmpt-433/public/r5/load_r5_mcu.sh
